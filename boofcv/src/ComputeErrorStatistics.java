...
//		String fileObservation = "../data/points_boofcv_chess_bumblebee2_left.txt";
		String fileObservation = "../data/points_opencv_chess_bumblebee2_left.txt";
		String fileResults = "../data/calib_boofcv_chess_bumblebee2_left.txt";

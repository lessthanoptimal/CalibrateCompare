...
public class CalibrateCameraPoints {
	...
	public static void main( String args[] ) throws IOException {
		...
		List<List<Point2D_F64>>  observations = loadObservations("../data/points_boofcv_chess_bumblebee2_left.txt");
//		List<List<Point2D_F64>>  observations = loadObservations("../data/points_opencv_chess_bumblebee2_left.txt");
